...
class ViewController: UIViewController {
   ...
   //Game properties
    ...
    //Theme Options
    /*
    var choosenTheme:Int = 0 {
        didSet{
            emojiChoices = gameTheme[choosenTheme]!
        }
    }
    
    var emojiChoices:[String] = ["👽","💀","☠️","👻","👺","👹","🤡","🎃","🦇","🕷","🦉"]
    
    var gameTheme:[Int:[String]] = [0:["👽","💀","☠️","👻","👺","👹","🤡","🎃","🦇","🕷","🦉"],
                     1:["🏀","🏹","🏊🏼‍♀️","🧗🏻‍♀️","🤽🏻‍♂️","🏓","🏏","🎳","🎲","🎰","🎾"],
                     2:["😎","😇","🤣","😜","😂","😬","🤑","🧐","🤐","😤","🙄"]
    ]
    
    var themeColors = [0:colorAttributes(buttonFaceUpColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), buttonFaceDownColor: #colorLiteral(red: 1, green: 0.5763723254, blue: 0, alpha: 1), screenBackgroundColor: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), flipCountColor: #colorLiteral(red: 1, green: 0.5763723254, blue: 0, alpha: 1)),
                       1:colorAttributes(buttonFaceUpColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), buttonFaceDownColor: #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1), screenBackgroundColor: #colorLiteral(red: 0.1215686277, green: 0.01176470611, blue: 0.4235294163, alpha: 1), flipCountColor: #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1)),
                       2:colorAttributes(buttonFaceUpColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), buttonFaceDownColor: #colorLiteral(red: 0.9994240403, green: 0.9855536819, blue: 0, alpha: 1), screenBackgroundColor: #colorLiteral(red: 0.5725490451, green: 0, blue: 0.2313725501, alpha: 1), flipCountColor: #colorLiteral(red: 0.9994240403, green: 0.9855536819, blue: 0, alpha: 1))
        ]*/
    
    //Implemenmtation in the form of an enum
    ...
    @IBAction public func chooseTheme(_ sender: UIButton) {
        ...
        if let themeIndex:Int = themeButton.index(of: sender){
            ...
            let choosenTheme:String = themeButton[themeIndex].currentTitle!
...
//            emojiChoices.remove(at: emojiChoices.count.arc4randomuniform)
